module github.com/agentra-ai/agentra/server

go 1.26.1

require (
	github.com/agentra-ai/agentra/pkg/taskgraph v0.0.0
...
replace github.com/agentra-ai/agentra/pkg/taskgraph => ./pkg/taskgraph
