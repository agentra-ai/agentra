...
-- name: GetEvalGoldenIssueBySlug :one
SELECT id, slug, category, workspace_id, issue_id, title, description, expected_test, max_duration_ms, created_at
FROM eval_golden_issues
