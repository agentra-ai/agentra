...
var loginCmd = &cobra.Command{
	...
	Long:  "Log in to Agentra, then automatically discover and watch all your workspaces.",
	RunE:  runLogin,
}
...
func runLogin(cmd *cobra.Command, args []string) error {
	...
	if err := autoWatchWorkspaces(cmd); err != nil {
		...
		fmt.Fprintf(os.Stderr, "Run 'agentra workspace list' and 'agentra workspace watch <id>' to set up manually.\n")
		return nil
	}
