...
type CloudFrontSigner struct {
	...
	domain       string // CDN domain, e.g. "static.agentra.ai"
	cookieDomain string // cookie scope, e.g. ".agentra.ai"
}
...
//   - CLOUDFRONT_DOMAIN       (e.g. "static.agentra.ai")
//   - COOKIE_DOMAIN           (e.g. ".agentra.ai")
