// Package seed defines the deterministic fixture contract for the future
// Agentra-Eval harness. These fixtures validate dataset structure only; they
// do not execute agents or measure implementation quality.

package seed

// FixtureCase is one proposed benchmark prompt and its output-matching regex.
...
// FixtureCases is the v0 dataset contract. The 25 cases are not a benchmark
// until a real runner captures agent outcomes in isolated repositories.
