...
const defaultCLIConfigPath = ".agentra/config.json"
...
// An empty profile returns the default path (~/.agentra/config.json).
// A named profile returns ~/.agentra/profiles/<name>/config.json.
func CLIConfigPathForProfile(profile string) (string, error) {
	...
	return filepath.Join(home, ".agentra", "profiles", profile, "config.json"), nil
}

// ProfileDir returns the base directory for a profile's state files (pid, log).
// An empty profile returns ~/.agentra/. A named profile returns ~/.agentra/profiles/<name>/.
func ProfileDir(profile string) (string, error) {
	...
	if profile == "" {
		return filepath.Join(home, ".agentra"), nil
	}
	return filepath.Join(home, ".agentra", "profiles", profile), nil
}
