...
const FILTERS: { value: MemoryFilter; key: MemoryFilter }[] = [
  { value: "all", key: "all" },
  { value: "learnings", key: "learnings" },
  { value: "results", key: "results" },
  { value: "context", key: "context" },
  { value: "patterns", key: "patterns" },
];
    ...
    <div className="space-y-6">
      <section className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-sm font-semibold">{tSettings("memory")}</h2>
        </div>
