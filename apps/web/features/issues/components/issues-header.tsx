...
export function IssuesHeader({ scopedIssues }: { scopedIssues: Issue[] }) {
  ...
  const scopes: { value: IssuesScope; label: string; description: string }[] = [
    ...
    { value: "members", label: t("filter.members.label"), description: t("filter.members.description") },
    { value: "agents", label: t("filter.agents.label"), description: t("filter.agents.description") },
  ];
          ...
          <DropdownMenuContent align="end" className="w-auto">
            ...
            <DropdownMenuSub>
              <DropdownMenuSubTrigger>
                ...
                <span className="flex-1">{t("detail.creator")}</span>
