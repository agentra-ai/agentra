...
export const useWorkspaceStore = create<WorkspaceStore>((set, get) => ({
  ...
  hydrateWorkspace: async (wsList, preferredWorkspaceId) => {
    ...
    localStorage.setItem("agentra_workspace_id", nextWorkspace.id);
  ...
  switchWorkspace: async (workspaceId) => {
    ...
    localStorage.setItem("agentra_workspace_id", ws.id);
  ...
  refreshWorkspaces: async () => {
    ...
    const storedWorkspaceId = localStorage.getItem("agentra_workspace_id");
    try {
